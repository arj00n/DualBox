...
using DualSensePass.Core;
using Nefarius.ViGEm.Client;
using Nefarius.ViGEm.Client.Targets;
using Nefarius.ViGEm.Client.Targets.Xbox360;

namespace DualSensePass.VirtualGamepad;

public sealed record XboxRumble(byte LargeMotor, byte SmallMotor);
...
public sealed class VirtualXboxController : IDisposable
{
    ...
    {
        RumbleReceived?.Invoke(this, new XboxRumble(e.LargeMotor, e.SmallMotor));
    }
